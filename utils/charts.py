...
def radar_chart(df):
    ...
    for _, row in df.iterrows():
        ...
        fig.add_trace(
            go.Scatterpolar(
                r=[
                    row["repository_health_score"],
                    row["merge_rate"],
                    row["issue_closure_rate"],
    ...
    fig.update_layout(
        ...
        title="Overall Repository Comparison",
        **PLOT_LAYOUT
    )
